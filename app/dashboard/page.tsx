import { BentoGrid, BentoGridImageCard } from "@/components/ui/bento-grid";
import {
...
const DashboardPage = () => {
  return (
    <div className="flex flex-1">
      <BentoGrid className="max-w-7xl max-auto md:autorow-[20rem] p-8">
        {items.map((item, i) => (
          <BentoGridImageCard
            key={i}
            title={item.title}
            ...
            header={item.header}
            icon={item.icon}
            className={isSpecialIndex(i) ? "md:col-span-2" : ""}
          />
        ))}
      </BentoGrid>
    </div>
